...
class SplitLayoutImpl final : public ISplitLayout
{
  public:
    ...
    bool                           Split(const SplitNode *panel, SplitDirection direction, std::string_view new_editor_name, float ratio, bool split_to_first) override;
    ...
    GetLayoutDocument() const noexcept
    {
        return layout_document_;
    }
